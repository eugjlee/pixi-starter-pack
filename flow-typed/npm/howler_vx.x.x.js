// flow-typed signature: 50049e5222d1c9273149b50ce6d25a2a
// flow-typed version: <<STUB>>/howler_v^2.0.9/flow_v0.68.0
...
declare module 'howler' {
  ...
  declare type HowlerGlobal = {
    ...
    ctx: AudioContext,
    masterGain: GainNode,
    stereo(pan: number): HowlerGlobal,
    pos(x: number, y: number, z: number): HowlerGlobal | void,
    orientation(
      x: number,
      y: number,
      z: number,
